...
abstract class KenaryDatabase: RoomDatabase(){
    ...
    private class PopulateDbAsync internal constructor(db: KenaryDatabase): AsyncTask<Void, Void, Void>(){
        ...
        override fun doInBackground(vararg params: Void): Void? {
            ...
            listonga.add(TutorialEntity(2, "Probabilidad y estadistica", "Probabilidad y estadistica", "Gabriel Garcia", "Nelson Castro","https://image.freepik.com/vector-gratis/proceso-de-desarrollo-de-aplicaciones-moviles_1200-441.jpg", "Programación Orientada a Objetos", "UCA", "1:30 PM","24/07/18", "6.77$"))
            listonga.add(TutorialEntity(3, "Fisica","Fisica", "Javier Parada", "Arturo Salgado","https://4.bp.blogspot.com/-d9jmYTqXzLQ/V6Cnnpgel1I/AAAAAAAAAps/ZNM1o82BwTQ0BpHuysCvSIly9jEzjgGSACLcB/s320/qu%25C3%25ADmica.jpg", "Programación Orientada a Objetos", "UCA", "9:00 AM","24/07/18", "6.77$"))
